...
#[diesel(table_name = games)] // or whatever table, this is just for the derive
...
pub async fn get_site_statistics_games_by_type_by_period(
        ...
        let game_type_filter = match included_game_types.as_str() {
            "Full" => vec!["Base+MLP"],
            "Base" => vec!["Base"],
            "Full & Base" => vec!["Base+MLP", "Base"],
            _ => vec!["Base+MLP", "Base"],
        };
    ...
    pub async fn get_site_statistics_most_active_players_by_period(
        ...
        let game_type_filter = match included_game_types.as_str() {
            "Full" => "AND g.game_type = 'Base+MLP'",
            "Base" => "AND g.game_type = 'Base'",
            "Full & Base" => "",
            _ => "",
        };
    ...
    pub async fn get_site_statistics_winrate_by_rating_difference(
        ...
        let game_type_filter = match included_game_types.as_str() {
            "Full" => "AND game_type = 'Base+MLP'",
            "Base" => "AND game_type = 'Base'",
            "Full & Base" => "",
            _ => "",
        };
