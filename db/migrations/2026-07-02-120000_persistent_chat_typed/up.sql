...
CREATE INDEX chat_channels_direct_high_user
    ON chat_channels (direct_user_high_id)
    WHERE kind = 'direct';
...
CREATE INDEX tournaments_users_user_tournament
    ON tournaments_users (user_id, tournament_id);

CREATE INDEX tournaments_organizers_organizer_tournament
    ON tournaments_organizers (organizer_id, tournament_id);

CREATE INDEX games_white_id_id
    ON games (white_id, id);

CREATE INDEX games_black_id_id
    ON games (black_id, id);
...
CREATE TABLE chat_messages (
    ...
    CONSTRAINT chat_messages_turn_nonnegative_check
