...
// A copy of `db/tests/common/db.rs`; only this path differs, because `embed_migrations!`
// resolves against the *including* crate's manifest directory, not the migrations' own crate.
