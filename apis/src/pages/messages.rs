...
const MESSAGES_SHELL_CLASS: &str =
    "fixed inset-x-0 bottom-0 top-10 z-0 flex overflow-hidden flex-col border-t border-black/10 bg-light dark:border-white/10 dark:bg-surface-muted sm:flex-row";
const MESSAGES_SIDEBAR_PANE_CLASS: &str =
    "flex min-h-0 w-full flex-shrink-0 flex-col overflow-hidden border-black/10 bg-light dark:border-white/10 dark:bg-surface-muted sm:w-72 sm:border-r";
...
const MESSAGES_PRIMARY_HEADER_CLASS: &str =
    "flex min-h-11 items-center justify-between gap-3 border-b border-black/10 bg-light px-3 py-2.5 dark:border-white/10 dark:bg-surface-muted xs:px-4 xs:py-3";
const MESSAGES_SUBHEADER_CLASS: &str =
    "flex shrink-0 items-center justify-between gap-3 border-b border-black/10 bg-light px-3 py-2.5 dark:border-white/10 dark:bg-surface-muted xs:px-4 xs:py-3";
    ...
    view! {
        <div class=MESSAGES_INDEX_PANE_CLASS>
            <div class="flex flex-1 justify-center items-center p-4">
                <EmptyState
                    title=move || t_string!(i18n, messages.page.select_conversation)
                    message=move || t_string!(i18n, messages.page.choose_conversation)
                    class="max-w-sm"
                />
            </div>
        </div>
...
const SECTION_HEADER_BTN: &str = "ui-disclosure-summary sticky top-0 z-10 min-h-10 w-full justify-between rounded-none text-left text-xs uppercase text-gray-600 dark:text-gray-300";
const EMPTY_HINT_CLASS: &str = "px-2 py-1.5 text-sm text-gray-500 dark:text-gray-400 italic";
...
const CHANNEL_BTN_SELECTED: &str = "ui-segmented-active font-bold";
    ...
    view! {
        <div class=MESSAGES_THREAD_PANE_CLASS>
            <div class=MESSAGES_PRIMARY_HEADER_CLASS>
                ...
                >
                    <Icon icon=icondata_lu::LuArrowLeft attr:class="size-4" />
