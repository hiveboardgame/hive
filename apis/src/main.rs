...
async fn main() -> std::io::Result<()> {
    ...
    websocket::run_tournament_start(pool.clone(), Data::clone(&websocket_server));
    websocket::run_heartbeat(Data::clone(&websocket_server));
   websocket::run_ping(Data::clone(&websocket_server));
