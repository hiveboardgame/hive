...
pub fn Header() -> impl IntoView {
    ...
    let i18n = use_i18n();
    view! {
        <header class="flex fixed top-0 z-50 justify-between items-center w-full bg-gray-300 select-none h-[calc(2.5rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] max-w-[100vw] dark:bg-header-twilight">
